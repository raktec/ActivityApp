...
//timer Stop by rakesh if want to open uncomment this method :checkWetherToToggleSlideshowTimer
...
@synthesize tileDisabled = _tileDisabled;
...
- (void) initializeCaption
{
   ...
   if(!_tileDisabled) [self addSubview:_captionLabel];
